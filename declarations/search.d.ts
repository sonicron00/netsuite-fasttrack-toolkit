 ...
 */
export declare type ObjectWithId<T> = T & {
    id: string;
};
/**
 ...
 */
export declare type BaseSearchResult<T> = ObjectWithId<T> & {
 ...
 *  ```
 */
export declare function nsSearchResult2obj<T = {}>(useLabels?: boolean): (r: search.Result) => BaseSearchResult<T>;
/**
 ...
 * ```
 */
export declare class LazySearch implements Iterator<search.Result | null> {
    private search;
    private pageSize;
    /**
